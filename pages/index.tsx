    ...
    <div className="flex flex-col items-center justify-center py-2">
      <div>
        ...
        <main className='flex flex-col items-center justify-center w-full flex-1 px-20 text-center'>
          ...
          <div className='flex flex-wrap items-center justify-around max-w-4x1 mt-6 sm:w-full'>
            <div className='p-8 mt-6 border w-96 rounded-xl hover:text-blue-600 focus:text-blue-600'>
              <div className='w-full max-w-sm'>
                <form className='bg-white rounded px-8 pt-6 pb-8 mb-4'>
                  ...
                  <div className='mb-4'>
                    <label className='block text-gray-700 text-sm font-bold mb-2' htmlFor='taskActivity'>
                      Task Activity
                    </label>
                    <textarea 
